...
export type IconName =
  ...
  | "dot3" | "star" | "minus" | "info" | "calendar" | "download" | "copy";
...
const paths: Record<IconName, ReactNode> = {
  ...
  // Two sheets, one behind the other — the copy-to-clipboard convention. Added
  // for the volunteer sheet's "Copy volunteer emails"; the four sibling apps'
