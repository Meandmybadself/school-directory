 ...
 *  shared rather than Person-scoped, so this offers the one thing that does apply:
 *  sign out. (It used to link to the directory too; the platform switcher —
 *  AppSwitcher.tsx — now does that for every sibling app.) */
