...
//
// The generic half of the calendar's Sheets.tsx — its SubscribeSheet is a
// calendar-only affordance and was dropped rather than carried, the same way
// this app's parts.tsx keeps only the non-directory half of apps/web's.
